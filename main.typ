...
#figure(
  ...
  align(left)[
    ...
    _Syntax extension (helpers):_ $t ::= ... | t "? " l | t "//" t | t "++" t | t.l "or" t$
    #v(8pt)
  ],
)
...
```rust
coalesced(r#"x: x + "hi";"#) // "α ∧ String -> (String)"
