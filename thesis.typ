...
#figure(caption: "Syntax and typing syntax for primitives", 
align(left)[
...
#typings("Primitves typing rules", ((
...
#align(center)[
  #pad_stack((
    ...
    derive("T-Lst-Hom", ($Γ tack t_0: τ$, "...", $Γ tack t_n: τ$), $ Γ tack [ " " t_0 " " t_1 " " ... " " t_n " "]: [ τ]$),
    derive("T-Lst-Agg", ($Γ tack t_0: τ_0$, "...", $Γ tack t_n: τ_n$), $ Γ tack [space t_0 space t_1 space ... " " t_n] <=  [ τ_0 space τ_1 space ... space τ_n]$))
...
((
      ...
      derive("S-List-Concat-Mutli", ($Γ tack a: [arrow(τ_1)]$, $Γ tack b: [arrow(τ_2)]$ ), $Γ tack a "++" b: [arrow(τ_1)arrow(τ_2)]$),

      ),(
      derive("T-Rec-Update", ($Γ tack a: { l_i: τ_i }$, $Γ tack b: { l_j: τ_j }$), $Γ tack a "//" b: a backslash b union b $) ,
    ),)
)
